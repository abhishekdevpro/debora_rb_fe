            ...
            <div className="relative">
              ...
              >
                <ul className="space-y-2 mt-4">
                  ...
                  <li
                    className="flex items-center p-2 hover:bg-pink-500  border-b-2 rounded font-semibold cursor-pointer "
                    onClick={() => {
                      setIsModalOpen(true);
                      toggleSidebar();
                    }}
            ...
            <div>
              <div className="flex justify-center">
                <button
                  ...
                  className="rounded-lg border-2 bg-black  w-full lg:w-40 text-white px-10 py-1"
                >
                  Previous
                </button>
                      ...
                      <li
                        ...
                        className={`px-4 py-2 cursor-pointer ${
                          currentSection === index
                            ? "rounded-lg border-2 border-purple-800 font-bold bg-purple-800 text-white px-10 py-1"
                            : "rounded-lg border-2 bg-white border-purple-900  text-purple-800 px-10 py-1"
                        }`}
                ...
                <button
                  type="button"
                  onClick={handleNext}
                  className="rounded-lg px-10 font-bold border-2 bg-purple-900 w-full lg:w-40 text-white py-1"
                >
              ...
              >
                ...
                <div className="lg:flex gap- content-center  justify-between bg-gray-200 p-1 px-5 lg:block hidden">
                  <select
                    ...
                    className="rounded-lg border-2 border-purple-800 px-5 p- font-bold text-purple-800 lg:block hidden
                    m-2   py-2  bg-white  "
                  >
