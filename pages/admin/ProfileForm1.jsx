...
const ProfileForm1 = () => {
  const boxes = [ 
    ...
    <Link href="/admin/templatelist" key="box2">
      <div className="bg-pink-900 hover:bg-gray-300 hover:text-black rounded-lg shadow-md pt-16 w-96 h-60 text-center text-white cursor-pointer text-3xl font-semibold">
      <div className='text-5xl'>📋</div><br/>My Templates
      </div>
    </Link>,
    <Link href="/admin/addreferall1" key="box3">
      <div className="bg-pink-900 hover:bg-gray-300 rounded-lg shadow-md pt-16 w-96 h-60 text-center cursor-pointer text-white text-3xl font-semibold">
